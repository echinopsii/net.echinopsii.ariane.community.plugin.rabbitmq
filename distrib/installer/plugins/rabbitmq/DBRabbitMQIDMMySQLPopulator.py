...
class DBRabbitMQIDMMySQLPopulator(AMySQLdbInit):
    ...
    def __init__(self, db_config):
        ...
        self.sqlScriptFilePath = "resources/sqlscripts/plugins/rabbitmq/idm_plugin_rabbitmq_insert.sql"

    def process(self):
        return super(DBRabbitMQIDMMySQLPopulator, self).process()
